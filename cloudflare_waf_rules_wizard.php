...
function pw_cloudflare_ruleset_manager_process_zones() {
    ...
    $rules = [
        [
            ...
            'expression' => '(cf.client.bot) or (cf.verified_bot_category in {"Search Engine Crawler" "Search Engine Optimization" "Monitoring & Analytics" "Advertising & Marketing" "Page Preview" "Academic Research" "Security" "Accessibility" "Webhooks" "Feed Fetcher"}) or (http.user_agent eq "letsencrypt" and http.request.uri.path contains "acme-challenge")',
            'action' => 'skip',
            'action_parameters' => [
                'ruleset' => 'current',
